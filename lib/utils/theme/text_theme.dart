...
class TTextTheme{
  ...
  static TextTheme lightTextTheme=TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.normal,color: Colors.black.withOpacity(.5)),
  ...
  static TextTheme darkTextTheme=TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.normal,color: Colors.white.withOpacity(.5)),
